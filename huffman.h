...
protected:
	...
	int binary_to_decimal(string a);															//convert a 8-bit 0/1 string of binary code to a decimal integer 
	string decimal_to_binary(int);															//convert a decimal integer to a 8-bit 0/1 string of binary code
	inline void build_tree(string& a, char c);													//build the huffman tree according to information from file 
